...
variable "enable_boot_diagnostics" {
  description = "Whether to enable Azure boot diagnostics (console screenshot + serial log) on this VM - useful while the environment is still being stood up/validated, safe to turn off afterward"
  type        = bool
  default     = true
}
